# Answer stolen from because I couldn't figure it out: https://github.com/PodolskiBartosz/advent-of-code-2022/blob/main/day-7/main.py
...
def main():
    ...
    file_task_1 = open('../part_1/input.txt', 'r')
    file_task_2 = open('../part_1/input.txt', 'r')
    task_1(file_task_1)
    task_2(file_task_2)
        ...
        if line[0] == "$":
            if line[1] != "ls":
                if line[2] == "..":
                    ...
                    current_path = f"{current_path}/{line[2]}"
...
def task_1(file):
    ...
    sum_small_directories = sum(
        directory for _, directory in directories.items() if directory < 100000
    )
    print(f"Task 1 result: {str(sum_small_directories)}")
...
def task_2(file):
    ...
    print(f"Task 2 result: {str(smallest_deletable_directory)}")
